...
def welcome():
    ...
    return"""<html>
    <h1>Yo welcome to Drew's sweet Hawaiian Weather Data API!  </h1>
    <ul>
    <br>
    <li>
    Wanna know how much it rained in hawaii last year?
    <br>
    <a href="/api/v1.0/precipitation">/api/v1.0/precipitation</a>
    </li>
    <br>
    <li>
    Want a list of the weather stations where this was measured?: 
    <br>
   <a href="/api/v1.0/stations">/api/v1.0/stations</a>
   </li>
    <br>
    <li>
    Want to know if winter is coming in hawaii?  Check the Temperature Observations for the previous year:
    <br>
    <a href="/api/v1.0/tobs">/api/v1.0/tobs</a>
    </li>
    <br>
    <li>
    Hey, maybe you care about a certain date? Try this: tmin, tmax, tavg for the dates greater than or equal to the date provided:
    ...
    <br>
    <li>
    What about a range of dates?  This will get you tmin, tmax, tavg for the dates in range of start date and end date inclusive:
    <br>
...
def precipitation():
    ...
    # Time delta = 366 so that the first day of the year is included
...
def tobs(): 
    ...
    # More time delta 366 stuff to get last years date
